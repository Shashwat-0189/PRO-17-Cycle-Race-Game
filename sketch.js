...
var bellSound,checkPointSound,dieSound, stSound;
var distance=0;
...
restart=createSprite(350,200,1,1);
...
function draw() {
  ...
  if(gameState===START){
    ...
    fill("red");
    textSize(20);
    text("PRESS 'SHIFT' TO RING THE BELL",185,270);
  if(keyDown("space")){
    gameState = PLAY;
    stSound.play();
  }
  ...
  createObstacle3();
    ...
    path.velocityX=-(6+2*distance/120);
